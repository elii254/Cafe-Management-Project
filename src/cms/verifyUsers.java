...
public class verifyUsers extends javax.swing.JFrame {
    ...
    public void getAllRecords(String email)
    {
        ...
        ArrayList<User> list = userDao.getAllReocords(email);
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 81, 200, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 1346, 548));

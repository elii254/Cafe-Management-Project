...
//        }catch(Exception e)
//        {
//            JOptionPane.showMessageDialog(null, "this it");
//        }
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        int a = JOptionPane.showConfirmDialog(null, "Do you want to to remove this product","Select",JOptionPane.YES_NO_OPTION);
        if(a==0)
        {
